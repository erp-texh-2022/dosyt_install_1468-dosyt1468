...
sudo -H pip3 install -r https://raw.githubusercontent.com/erp-texh-2022/corsma_14c_source/main/requirements.txt
...
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/erp-texh-2022/corsma_14c_source $OE_HOME_EXT/
...
EOF
  ...
  sudo mv ~/dosytent1454 /etc/nginx/sites-available/
...
if [ $INSTALL_NGINX = "True" ]; then
  echo "Nginx configuration file: /etc/nginx/sites-available/dosytent1454"
fi
echo "-----------------------------------------------------------"
